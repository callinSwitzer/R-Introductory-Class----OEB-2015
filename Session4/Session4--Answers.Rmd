...
### 2.1 Write one for loop for the numbers 1:100.  
...
### 2.2 The following function prints the max or the highest level of a factor.
...
### E.3 Change the theme from your previous plot to the "classic" theme with theme_classic().
```{r}
ggplot(lob, aes(x = age, y = height)) + 
     geom_boxplot() + 
     geom_point(aes(color = seed)) + 
